        ...
        while (true) {
            ...
            switch (line) {
                case "1": {
                    ...
                    switch (type) {
                        case "a": {
                            managerCandidate.addCandidate(createCadidate(scanner, "a"));
                            break;

                        }
                        case "b": {
                            managerCandidate.addCandidate(createCadidate(scanner, "b"));
                            break;
                        }
                        case "c": {
                            managerCandidate.addCandidate(createCadidate(scanner, "c"));
                            break;
                        }
                        default:
